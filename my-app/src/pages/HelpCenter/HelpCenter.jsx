...
import { Footer, Header, QA } from '../../components';
...
const HelpCenter = () => {
    ...
    const searchHandler = () => {
        console.log('searchInput', searchInput.current);
        console.log('questions', questions);
        
        const newQuestion = questionsHelpData.filter(question => question.title.includes(searchInput.current));
    ...
    return (
        <div>
            ...
            <div className="relative flex justify-center mb-[300px] xl:mb-[350px]">
                <div className='h-[150px] xl:h-[300px] bg-[#FDB713] w-full'>
                </div>
                    ...
                    box-shadow xl:py-20'>
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <div className='flex flex-col items-center md:flex-row justify-center w-full md:my-10'>
                                <input type="text" onChange={(e) => {searchInput.current=e.target.value}}  className='border-1 border-12 text-2xl p-4 w-[90%] md:w-[70%] md:h-1/2 xl:h-full my-10 text-gray-600 md:ml-5 md:my-0' placeholder='جست و جو راهنمایی استرداد ، خرید بلیط و ...'/>
                                <button onClick={searchHandler} className='bg-[#FDB713] p-4  text-gray-800 w-[90%] md:w-[20%] md:h-1/2 xl:p-5 text-2xl mb-4 border-12'>جست و جو</button>
                            </div>
                        </div>
                </div>
            </div>
                <div className='px-20 md:flex justify-center'>
                        <div className='flex justify-between items-center dr-rtl border-1 border-12 p-6  transition-all m-4 lg:w-full lg:w-[300px] xl:w-[350px] box-shadow-hover cursor-pointer'>
                            ...
                            <div>
                                <ArrowBackIosNewIcon style={{fill : '#989898FF',fontSize : '2rem'}}/>
                            </div>
                        </div>
                        <div className='flex justify-between items-center dr-rtl border-1 border-12 p-6  transition-all m-4 lg:w-full lg:w-[300px] xl:w-[350px] box-shadow-hover cursor-pointer'>
                            <div>
